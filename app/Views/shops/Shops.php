...
<body>
    <header class="site-header sticky-top py-1">
        <nav class="container d-flex flex-column flex-md-row justify-content-between shadow-sm">
            <a class="py-2" href="#" id="branding" aria-label="Product">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div id="cart-dropdown" class="dropdown my-auto d-md-inline-block text-decoration-none mx-2"></div>
                <div id="wishlist-dropdown" class="dropdown my-auto d-md-inline-block text-decoration-none mx-2"></div>
            </div>
        </nav>
    </header>
    <main>
        <div class="container">
            <div class="row my-4">
                <div id="sidebar-container" class="col-12 col-md-3">
                </div>
