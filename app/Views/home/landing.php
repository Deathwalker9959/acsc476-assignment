...
<head>
    ...
    <link href="assets/landing/product.css" rel="stylesheet" />
</head>
...
<body>
    ...
    <main>
        <div class="position-relative overview overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
            <div class="row h-100">
                <div class="col"></div>
                <div class="col">
                    <div class="product-device d-md-block fa fa-burger"></div>
