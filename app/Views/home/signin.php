...
<body class="text-center">
    <main class="form-signin w-100 m-auto">
        <form method="POST" <?php if (isset($data["register"])) { ?> action="/api/register" <?php } else { ?> action="/api/login" <?php } ?>>
            ...
            <?php if (isset($data["register"])) { ?>
                <div class="form-floating">
                    <input type="text" class="form-control" id="floatingInput" placeholder="John Smith" name="name" data-style="top" />
