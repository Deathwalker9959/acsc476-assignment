...
<body>
    <header class="site-header sticky-top py-1">
        <nav class="container d-flex flex-column flex-md-row justify-content-between shadow-sm">
            ...
            <a class="px-2 d-none d-md-inline-block"></a>
            <a class="py-2 d-none d-md-inline-block text-decoration-none text-uppercase" href="/register">Signup</a>
            <a class="py-2 d-none d-md-inline-block text-decoration-none text-uppercase" href="/login">Login</a>
        </nav>
    </header>
                        ...
                        <div class="col text-center text-light">
                            <div class="row">
                                <div class="position-relative">
                                    ...
                                    <div class="d-inline-block rolling-container mx-2 text-left">
                                        <span class="h2">Coffee</span>
                                        <span class="h2">Burger</span>
                                        <span class="h2">Pizza</span>
                                        <span class="h2">Sandwich</span>
                                        <span class="h2">Supermarket</span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <h2 class="my-2 text-start">In under 1<small>s</small></h2>
                            </div>
                            <div class="row py-2 justify-content">
                                <div class="text-start">
                                    <a class="btn-primary btn text-center" href="/shops">Order Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
